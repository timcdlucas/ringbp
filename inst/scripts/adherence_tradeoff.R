...
#'title: "Adherence trade-ffs in COVID branching process"
#'author: Tim Lucas and Emma Davis
#'fontsize: 8pt
#'geometry: margin=0.5in
#'---

#' # Which areas are adherence most important?
#'
#' - Self report vs self isolation
#' - length of self isolation vs proportion of self-isolation
...
saveRDS(sweep_results, file = "data-raw/res_20200616_generalouts.rds")
