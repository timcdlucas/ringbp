...
scenarios1 <- tidyr::expand_grid(
  ...
  self_report = c(0.5),
  iso_adhere = c(0.65),
  test_delay = c(1,4), #time from isolation to test result
...
# #+ writeout
saveRDS(sweep_results1, file = "data-raw/res_Jan_1.rds")
rm(list=ls())
Sys.sleep(120)
...
# #+ writeout
saveRDS(sweep_results2, file = "data-raw/res_Jan_2.rds")
rm(list=ls())
Sys.sleep(120)
...
# #+ writeout
saveRDS(sweep_results3, file = "data-raw/res_Jan_3.rds")
rm(list=ls())
